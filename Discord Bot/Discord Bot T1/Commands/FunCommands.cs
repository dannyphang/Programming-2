using Discord_Bot_T1.Attributes;
...
namespace Discord_Bot_T1.Commands
{
    public class FunCommands : BaseCommandModule
    {
        ...
        {
            await ctx.Channel.SendMessageAsync("Pong").ConfigureAwait(false); // just to send a msg
        }
        ...
        public async Task RespondMessage(CommandContext ctx)
        {
            ...
            await ctx.Channel.SendMessageAsync("May I help you?");
