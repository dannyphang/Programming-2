...
module.exports = {
    ...
    callback: async ({ channel, args }) => {
        ...
        if(args.length == 0){
            ...
            else if(stateNo == -1 && index != -1){ // state: false, date: false
                const embed = new MessageEmbed()
        ...
        //     }
        //     else{
        //         return `Incorrect usage! Please use "${prefix() + path.basename(__filename, path.extname(__filename))} <State>"`
        //     }
        // }
    },
}